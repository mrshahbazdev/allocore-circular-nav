...
import { tools, categories, bundles } from "@/lib/tools-data";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="relative pt-20 pb-12 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p
              className="text-3xl md:text-4xl text-muted-foreground/80 mb-6 font-light tracking-wide"
              style={{ fontFamily: "Work Sans, sans-serif" }}
            >
              Effizienz durch{" "}
              <span className="font-semibold text-foreground">Fokus</span>
            </p>
            ...
            <p
              ...
              style={{ fontFamily: "Work Sans, sans-serif" }}
            >
              Wir helfen KMUs und Beratern, Ressourcen optimal auf ihr
              Kerngeschäft auszurichten und nachhaltig profitabel zu wachsen
            </p>
          ...
          <div className="max-w-5xl mx-auto">
            <AnimatedSection animation="fade-up">
              <div className="text-center mb-8">
                <p
                  className="text-sm font-bold text-[#FF8C00] uppercase tracking-wider mb-4"
                  style={{ fontFamily: "Rajdhani, sans-serif" }}
                >
                  Die Herausforderung
                </p>
                ...
                <p
                  ...
                  style={{ fontFamily: "Work Sans, sans-serif" }}
                >
                  Viele erfolgreiche Unternehmen kämpfen mit den gleichen
              ...
              {[
                {
                  ...
                  description:
                    "Zeit und Geld fließen in zu viele Richtungen ohne klaren Fokus auf das Wesentliche",
                  icon: Clock,
                },
                {
                  title: "Ineffiziente Prozesse",
                  description:
                    "Komplexe Abläufe bremsen das Wachstum und kosten unnötig Energie und Kapital",
                  icon: ZapIcon,
                },
                {
                  title: "Unklare Positionierung",
                  description:
                    "Zu breites Angebot verwässert die Botschaft und erschwert die Kundengewinnung erheblich",
                  icon: MessageSquare,
                },
              ].map((problem, index) => (
                <AnimatedSection
                  ...
                  animation="fade-up"
                >
                  <div className="group bg-card p-8 rounded-2xl border-2 border-destructive/10 hover:border-destructive/30 transition-all duration-300 hover:shadow-xl">
        ...
        <div className="container relative z-10">
          <AnimatedSection animation="fade-up">
            <div className="text-center mb-12">
              <p
                className="text-sm font-bold text-[#0D9BA6] uppercase tracking-wider mb-4"
                style={{ fontFamily: "Rajdhani, sans-serif" }}
              >
                Die Lösung
              </p>
        ...
        <div className="container">
          <AnimatedSection animation="fade-up">
            <div className="text-center mb-20">
              ...
              >
                Messbare{" "}
                <span className="text-muted-foreground/60">Verbesserungen</span>
              </h2>
              <p
                className="text-xl text-muted-foreground max-w-2xl mx-auto"
                style={{ fontFamily: "Work Sans, sans-serif" }}
            ...
            {[
              {
                ...
                title: "Mehr Profit",
                description:
                  "Durch optimale Ressourcenallokation steigt die Profitabilität nachhaltig und planbar",
                color: "#FF8C00",
                stat: "+150%",
              ...
              },
              {
                ...
                title: "Mehr Klarheit",
                description:
                  "Fokus auf das Kerngeschäft schafft Orientierung für alle strategischen Entscheidungen",
                color: "#0D9BA6",
                stat: "100%",
              ...
              },
              {
                ...
                description:
                  "Vereinfachte Prozesse und Angebote machen das Unternehmen agiler und effizienter",
                color: "#FF8C00",
                stat: "-40%",
              ...
              <AnimatedSection
                ...
                animation="fade-up"
              >
                <div className="group bg-card p-10 rounded-2xl border-2 border-border hover:border-[#FF8C00] transition-all duration-300 hover:shadow-2xl text-center relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <AnimatedSection animation="fade-up">
            <div className="text-center mb-20">
              ...
              >
                Ganzheitliche{" "}
                <span className="text-muted-foreground/60">Beratung</span>
              </h2>
              <p
                className="text-xl text-muted-foreground max-w-2xl mx-auto"
                style={{ fontFamily: "Work Sans, sans-serif" }}
            ...
            {[
              {
                ...
                description:
                  "Identifikation und Konzentration auf Ihr profitabelstes Geschäftsfeld mit datenbasierter Analyse",
              ...
              },
              {
                ...
                description:
                  "Optimale Verteilung von Ressourcen nach dem bewährten Profit-First-Prinzip",
                cta: "Mehr erfahren",
                number: "02",
                icon: DollarSign,
              },
              {
                ...
                description:
                  "StoryBrand-basierte Positionierung für klare und überzeugende Kundenansprache",
              ...
              },
              {
                ...
                description:
                  "Suchmaschinenoptimierung als effizientestes und nachhaltigstes Akquisesystem für organische Sichtbarkeit",
              ...
              },
              {
                ...
                description:
                  "Intent-basierte Website-Struktur für maximale Conversion und optimale Nutzerführung",
              ...
              },
              {
                ...
                description:
                  "Strukturiertes 2/2/2-System für systematische und effiziente Kundengewinnung",
                cta: "System starten",
                number: "06",
                icon: Network,
              },
        ...
        <div className="container">
          <AnimatedSection animation="fade-up">
            <div className="text-center mb-20">
              ...
              >
                Unternehmen, die mit{" "}
                <span className="text-[#FF8C00]">allocore</span> gewachsen sind
              </h2>
              <p
                className="text-xl text-muted-foreground max-w-2xl mx-auto"
                style={{ fontFamily: "Work Sans, sans-serif" }}
            ...
            {[
              {
                ...
                testimonial:
                  "Die allocore-Methode hat uns geholfen, unsere Prozesse zu optimieren und nachhaltig zu wachsen. Der Fokus auf unser Kerngeschäft war der Wendepunkt.",
              ...
              },
              {
                ...
                testimonial:
                  "Durch die strukturierte Herangehensweise konnten wir unsere Finanzen in den Griff bekommen und endlich profitabel arbeiten.",
                name: "Sarah Weber",
                position: "Inhaberin",
              ...
              },
              {
                ...
                testimonial:
                  "Das Networking-System und die Website-Optimierung haben unsere Sichtbarkeit enorm gesteigert. Wir müssen nicht mehr aktiv akquirieren.",
                name: "Thomas Müller",
                position: "CEO",
              ...
              <AnimatedSection
                ...
                animation="fade-up"
              >
                <div className="group bg-card p-10 rounded-2xl border-2 border-border hover:shadow-2xl transition-all duration-300 hover:border-[#FF8C00] relative overflow-hidden">
                  <div
                  ...
                  <p
                    className="text-muted-foreground mb-8 italic leading-relaxed text-lg"
                    style={{ fontFamily: "Work Sans, sans-serif" }}
                  >
                    "{story.testimonial}"
                  </p>
        ...
        <div className="container relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              >
                Unsere{" "}
                <span className="text-muted-foreground/60">Philosophie</span>
              </h2>
              <div className="max-w-3xl mx-auto mb-10">
                <p
                  className="text-3xl md:text-4xl text-[#FF8C00] font-semibold mb-8 italic leading-relaxed"
                  style={{ fontFamily: "Work Sans, sans-serif" }}
                >
                  "Mache die Dinge so einfach wie möglich — aber nicht
                  einfacher."
                </p>
                <p
                  ...
                  style={{ fontFamily: "Work Sans, sans-serif" }}
                >
                  Wir sind spezialisiert auf KMUs und Berater, weil wir genau
                  wissen: In diesen Unternehmen zählt jede Ressource. Unsere
                  Methode kombiniert bewährte Prinzipien aus Betriebswirtschaft,
                  SaaS-Skalierung und praxiserprobte Effizienzstrategien zu
              ...
              {[
                {
                  ...
                  icon: TrendingUp,
                  description: "Fundierte BWL-Expertise",
                },
                {
                  title: "SaaS-Expertise",
                  icon: Zap,
                  description: "Digitale Skalierung",
                },
                {
                  title: "Praxiserfahrung",
                  icon: Users,
                  description: "Bewährte Methoden",
                },
              ].map((area, index) => (
                <div
                  key={index}
      ...
      {/* Tools Ecosystem Teaser */}
      <section id="tools" className="py-10 relative overflow-hidden">
          ...
          <AnimatedSection animation="fade-up">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#0D9BA6]/10 border border-[#0D9BA6]/20 mb-6">
                <Layers className="w-4 h-4 text-[#0D9BA6]" />
                <span
              ...
              >
                Das allocore{" "}
                <span className="text-[#FF8C00]">Tool-Ökosystem</span>
              </h2>
              <p
                className="text-xl text-muted-foreground max-w-3xl mx-auto"
                style={{ fontFamily: "Work Sans, sans-serif" }}
              >
                Alle Tools, die Sie brauchen — von Strategie über Marketing bis
                Finanzen — in einem Ökosystem
              </p>
            </div>
          </AnimatedSection>

          {/* Category cards with tool count */}
            ...
            {categories.map((cat, index) => {
              ...
              return (
                <AnimatedSection
                  ...
                  animation="fade-up"
                >
                  <div className="group bg-card p-6 rounded-2xl border-2 border-border hover:border-[#FF8C00] transition-all duration-300 hover:shadow-xl text-center">
                    <div
                      className="text-4xl font-bold mb-2"
                      style={{
                        color: cat.color,
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
              {tools.slice(0, 3).map(tool => {
                ...
                return (
                  <div
                    key={tool.id}
                    className="group bg-card p-6 rounded-2xl border-2 border-border hover:border-[#FF8C00] transition-all duration-300 hover:shadow-xl"
                  >
          ...
          <AnimatedSection delay={200} animation="fade-up">
            <div className="max-w-4xl mx-auto">
              <Accordion type="single" collapsible className="space-y-4">
                <AccordionItem
                  value="item-1"
                  className="bg-card border-2 border-border rounded-2xl px-8 hover:border-[#FF8C00] transition-colors"
                >
                  ...
                  <AccordionContent
                    className="text-muted-foreground text-lg leading-relaxed pb-6"
                    style={{ fontFamily: "Work Sans, sans-serif" }}
                  >
                    Die allocore-Methode wurde speziell für KMUs und Berater
                    entwickelt, die nachhaltiges Wachstum anstreben. Besonders
                    profitieren Unternehmen mit 5-50 Mitarbeitern, die ihre
                    Ressourcen optimieren und sich auf ihr profitabelstes
                    Kerngeschäft konzentrieren möchten.
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  ...
                  <AccordionContent
                    ...
                    style={{ fontFamily: "Work Sans, sans-serif" }}
                  >
                    Die Implementierung erfolgt schrittweise und kann an jeder
                    Stelle beginnen. Erste messbare Ergebnisse sehen die meisten
                    Kunden bereits nach 4-6 Wochen. Die vollständige Integration
                    aller 5 Säulen dauert typischerweise 3-6 Monate, abhängig
                    von Ihrer Ausgangssituation und Zielsetzung.
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  ...
                  <AccordionContent
                    ...
                    style={{ fontFamily: "Work Sans, sans-serif" }}
                  >
                    Die Investition richtet sich nach dem Umfang der
                    Zusammenarbeit und Ihren individuellen Zielen. In der
                    kostenlosen Erstberatung analysieren wir Ihre Situation und
                    erstellen ein maßgeschneidertes Angebot. Viele Kunden
                    refinanzieren die Beratungskosten bereits durch die ersten
                    Optimierungen.
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  ...
                  <AccordionContent
                    ...
                    style={{ fontFamily: "Work Sans, sans-serif" }}
                  >
                    Nein, das ist das Besondere an der allocore-Methode: Sie
                    können an jeder beliebigen Stelle beginnen. Wir empfehlen,
                    mit dem Bereich zu starten, der für Sie den größten Hebel
                    verspricht. Die anderen Säulen werden dann schrittweise
                    integriert, wenn Sie bereit sind.
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  <AccordionTrigger className="text-left py-6 hover:no-underline">
                    <span
                      ...
                      style={{ fontFamily: "Rajdhani, sans-serif" }}
                    >
                      Wie unterscheidet sich allocore von klassischer
                  ...
                  <AccordionContent
                    ...
                    style={{ fontFamily: "Work Sans, sans-serif" }}
                  >
                    Wir kombinieren bewährte betriebswirtschaftliche Prinzipien
                    mit modernen SaaS-Skalierungsstrategien und praxiserprobten
                    Effizienztools. Statt theoretischer Konzepte liefern wir
                    konkrete, sofort umsetzbare Maßnahmen mit messbaren
                    Ergebnissen. Unsere Methode ist speziell auf die Bedürfnisse
                    von KMUs zugeschnitten.
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  ...
                  <AccordionContent
                    ...
                    style={{ fontFamily: "Work Sans, sans-serif" }}
                  >
                    In einem 45-60 minütigen Gespräch analysieren wir Ihre
                    aktuelle Situation, identifizieren die größten Hebel für Ihr
                    Wachstum und zeigen konkrete erste Schritte auf. Sie
                    erhalten bereits in diesem Gespräch wertvolle Impulse, die
                    Sie sofort umsetzen können – völlig unverbindlich und
                    kostenfrei.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            ...
            <div>
              ...
              >
                <li>
                  <a
                    href="#methode"
                    className="opacity-70 hover:opacity-100 hover:text-[#FF8C00] transition-all"
                  >
                    Methode
                  </a>
                </li>
